...
2.1 During the beta period, users can try DRDS for free.
...
7.1 The service period is calculated from the date the distributed relational database DRDS is created successfully (not from the date you obtain the password for the distributed relational database DRDS) and confirmed based on the amount of money you have paid.
